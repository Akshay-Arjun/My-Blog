...
export default function Index() {
  ...
  <h2 style={{ textAlign: "center" }}>
    ...
    I'm 4k5h4y 4rjun. Here, you can find hackthebox writeups, hackerone reports, tryhackme writeups, and my certificates. I hope you enjoy reading my content.
    
  </h2>
  <h3 style={{ textAlign: "center" }}>
    Doing my B.Tech in Computer Science (Cybersecurity) at SR University, India
  </h3>
  <br />
